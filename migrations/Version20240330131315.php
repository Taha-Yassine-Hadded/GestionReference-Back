 ...
 */
final class Version20240330131315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (client_id INT AUTO_INCREMENT NOT NULL, nature_client_id INT NOT NULL, personne_contact VARCHAR(255) NOT NULL, client_raison_sociale VARCHAR(255) NOT NULL, client_adresse VARCHAR(255) NOT NULL, client_telephone VARCHAR(255) NOT NULL, client_email VARCHAR(255) NOT NULL, INDEX IDX_C74404554AAD8E0 (nature_client_id), PRIMARY KEY(client_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, appel_offre_id INT DEFAULT NULL, message VARCHAR(255) NOT NULL, date_creation VARCHAR(255) NOT NULL, INDEX IDX_BF5476CA308E35F8 (appel_offre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
